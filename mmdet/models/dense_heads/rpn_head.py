...
class RPNHead(AnchorHead):
    ...
    def _predict_by_feat_single(self,
        ...
        """将单张图像的网络输出转换为 box.记np为每个特征点上生成的先验个数.
        ...
        Args:
            ...
            mlvl_priors (list[Tensor]): 所有层级的先验, [[h * w * np, 4],] * nl.
        ...
        mlvl_valid_priors = []
        mlvl_scores = []
        # 来自不同层级上的box在NMS阶段应该是独立的,这里使用"层级索引"也就是level_ids
        # 作为label传入Batch-NMS来使它们分开进行NMS.
        level_ids = []
